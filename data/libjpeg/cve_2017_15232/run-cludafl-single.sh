...
SUFFIX="$1"
TARGET_DIR="/home/yuntong/vulnfix/data/libjpeg/cve_2017_15232"
...
rm -rf $output_dir
$AFL_CMD $AFL_OPTS_COMMON -p $AFL_PROG -i "$input_dir" -o "$output_dir" -- "$INSTRUMENTED_PROG" -crop 1x1+16+16 -onepass -dither ordered -dct float -colors 8 -targa -grayscale -outfile "$OUTPUT_TMP"  @@ 
