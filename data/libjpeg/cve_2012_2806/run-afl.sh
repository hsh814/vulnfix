...
TARGET_DIR="$VULNFIX_HOME/vulnfix/data/libjpeg/cve_2012_2806"
...
for file in "$SEED_DIR"*; do
    ...
    file_list=("exploit" "seed38" "seed39" "seed5" "seed9" "seed6" "seed4" "seed7" "seed8" "seed24" "seed36" "seed35" "seed46" "seed30" "seed41" "seed32" "seed43" "seed3" "seed50" "seed10" "seed44" "seed21" "seed40" "seed22" "seed2" "seed42" "seed31" "seed14" "seed19" "seed33" "seed37" "seed12" "seed34" "seed20" "seed17" "seed16" "seed29" "seed13" "seed28" "seed27" "seed18" "seed25" "seed15" "seed1" "seed11")
    ...
    $AFL_CMD $AFL_OPTS -i "$input_dir" -p "$AFL_PROG" -o "$output_dir" -b "$EXPLOIT" -- "$INSTRUMENTED_PROG" -colors 256 -bmp @@ &
