...
pushd source
  ...
  # for AFL argv fuzz
  sed -i '1283i #include "argv_fuzzing/argv-fuzz-inl.h"' src/split.c
  sed -i '1288i AFL_INIT_SET02("./split", AFL_HOME "/vulnfix/data/coreutils/gnubug_25003/dummy");' src/split.c
...
cp dafl_source/src/split cludafl-runtime/split