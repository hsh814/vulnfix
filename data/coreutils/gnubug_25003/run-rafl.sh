...
TARGET_DIR="$VULNFIX_HOME/vulnfix/data/coreutils/gnubug_25003"
...
INSTRUMENTED_PROG="${TARGET_DIR}/split.aflrun"
...
for file in "$SEED_DIR"*; do
    ...
    export AFL_NO_UI=1
    export PACFIX_TARGET_LINE=986
    export PACFIX_COV_EXE=${TARGET_DIR}/runtime/split.coverage
    export PACFIX_COV_DIR=${TARGET_DIR}/temp/output_$count
    export PACFIX_VAL_EXE=${TARGET_DIR}/runtime/split.valuation
