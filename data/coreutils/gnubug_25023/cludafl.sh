...
pushd source
  ...
  # for AFL argv fuzz
  sed -i '856i #include "argv_fuzzing/argv-fuzz-inl.h"' src/pr.c
  sed -i '860i AFL_INIT_SET0234("./pr", AFL_HOME "/vulnfix/data/coreutils/gnubug_25023/dummy", "-m", AFL_HOME "/vulnfix/data/coreutils/gnubug_25023/dummy");' src/pr.c
...
cp dafl_source/src/pr cludafl-runtime/pr