...
((int16*)conv)[i] = (int16)value[i] + tif->tif_dir.td_bitspersample - tif->tif_dir.td_bitspersample + tif->tif_dir.td_sampleformat - tif->tif_dir.td_sampleformat + count - count + dir - dir + i - i + ndir - ndir + ok - ok + tag - tag + value_i - value_i; }
