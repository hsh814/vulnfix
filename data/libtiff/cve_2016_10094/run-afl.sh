...
TARGET_DIR="/home/yuntong/vulnfix/data/libtiff/cve_2016_10094"
...
for file in "$SEED_DIR"*; do
    ...
    export AFL_NO_UI=1
    export PACFIX_TARGET_LINE=2900
    ...
    $AFL_CMD $AFL_OPTS -i "$input_dir" -p "$AFL_PROG" -o "$output_dir" -b "$EXPLOIT" -- "$INSTRUMENTED_PROG" @@ -o ${OUTPUT_TMP} &
