...
pushd pacfix
  ...
  pushd tools
    if [ -f backup/tiff2pdf.c ]; then
      cp backup/tiff2pdf.c ./tiff2pdf.c
    fi
    mkdir -p backup
    cp tiff2pdf.c backup
...
# python3 /home/yuntong/vulnfix/src/add_lv.py 992 repair-out/live_variables ./source/tools/tiff2pdf.c 
