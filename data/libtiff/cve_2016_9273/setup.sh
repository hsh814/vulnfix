...
-entry_point "main" -max_pre_iter 10 -slice "bug=tiffsplit.c:246" \
./smake_source/sparrow/tools/tiffsplit/*.i

rm -rf dafl_source && mkdir dafl_source
pushd dafl_source
  DAFL_SELECTIVE_COV="/home/yuntong/vulnfix/data/libtiff/cve_2016_9273/sparrow-out/bug/slice_func.txt" \
  DAFL_DFG_SCORE="/home/yuntong/vulnfix/data/libtiff/cve_2016_9273/sparrow-out/bug/slice_dfg.txt" \
...
cp raw_build/tools/tiffsplit ./tiffsplit
cp dafl_source/tools/tiffsplit ./tiffsplit.instrumented
