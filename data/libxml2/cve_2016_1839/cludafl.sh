...
pushd dafl_source
  DAFL_SELECTIVE_COV="$VULNFIX_HOME/vulnfix/data/libxml2/cve_2016_1839/sparrow-out/bug/slice_func.txt" \
  DAFL_DFG_SCORE="$VULNFIX_HOME/vulnfix/data/libxml2/cve_2016_1839/sparrow-out/bug/slice_dfg.txt" \
