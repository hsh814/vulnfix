...
TARGET_DIR="$VULNFIX_HOME/vulnfix/data/libxml2/cve_2016_1839"
...
for file in "$SEED_DIR"*; do
    ...
    $AFL_CMD $AFL_OPTS -i "$input_dir" -p "$AFL_PROG" -o "$output_dir" -b "$EXPLOIT" -- "$INSTRUMENTED_PROG" -html @@ &
