...
export PACFIX_COV_DIR=$VULNFIX_HOME/vulnfix/data/binutils/cve_2017_14745/temp/output2
export PACFIX_VAL_EXE=$VULNFIX_HOME/vulnfix/data/binutils/cve_2017_14745/runtime/objdump.valuation
mkdir -p $PACFIX_COV_DIR

input_dir=$SEED_DIR
output_dir=$VULNFIX_HOME/vulnfix/data/binutils/cve_2017_14745/aflrun_out2
rm -rf $output_dir
