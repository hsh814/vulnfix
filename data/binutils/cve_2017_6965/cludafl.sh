...
cp ./readelf.pacfix2.c ./source/binutils/readelf.c
...
cp ./readelf.dug.c ./source/binutils/readelf.c
cp ./elfcomm.dug.c ./source/binutils/elfcomm.c
...
cp ./dafl_source/binutils/readelf cludafl-runtime/readelf