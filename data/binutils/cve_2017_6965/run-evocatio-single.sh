...
cd $TARGET_DIR/evocatio-runtime
...
OUTPUT_DIR_BASE="${TARGET_DIR}/evocatio-runtime/out"
...
# AFL_CMD_CBI="$EVOCATIO/cd-bytes-identifier"
...
$AFL_CMD $AFL_OPTS_COMMON -k $EXPLOIT -i "$input_dir" -o "$output_dir" -- "$INSTRUMENTED_PROG" -w @@
