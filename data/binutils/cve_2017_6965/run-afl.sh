...
AFL_OUTPUT_BASE="/home/yuntong/vulnfix/data/binutils/cve_2017_6965/dafl"
INSTRUMENTED_PROG="/home/yuntong/vulnfix/data/binutils/cve_2017_6965/runtime/readelf.instrumented"
...
for file in "$SEED_DIR"*; do
    ...
    $AFL_CMD $AFL_OPTS -i "$input_dir" -p "$AFL_PROG" -o "$output_dir" -b "$EXPLOIT" -- "$INSTRUMENTED_PROG" -w @@ &
