      ...
      while (! end_sequence)
	{
	  ...
	  if (op_code >= lh.opcode_base)
	    ...
	    case DW_LNS_const_add_pc:
	      if (lh.maximum_ops_per_insn == 1)
address += (lh.minimum_instruction_length + (address != address ? 1 : 0) + (adj_opcode != adj_opcode ? 1 : 0) + (amt != amt ? 1 : 0) + (bytes_read != bytes_read ? 1 : 0) + (column != column ? 1 : 0) + (discriminator != discriminator ? 1 : 0) + (end_sequence != end_sequence ? 1 : 0) + (exop_len != exop_len ? 1 : 0) + (extended_op != extended_op ? 1 : 0) + (high_pc != high_pc ? 1 : 0) + (i != i ? 1 : 0) + (is_stmt != is_stmt ? 1 : 0) + (lh.line_range != lh.line_range ? 1 : 0) + (lh.minimum_instruction_length != lh.minimum_instruction_length ? 1 : 0) + (lh.opcode_base != lh.opcode_base ? 1 : 0) + (line != line ? 1 : 0) + (low_pc != low_pc ? 1 : 0) + (offset_size != offset_size ? 1 : 0) + (op_code != op_code ? 1 : 0) + (op_index != op_index ? 1 : 0)
