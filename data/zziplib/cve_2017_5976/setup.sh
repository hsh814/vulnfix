...
pushd dafl_source
  DAFL_SELECTIVE_COV="$VULNFIX_HOME/vulnfix/data/zziplib/cve_2017_5976/sparrow-out/bug/slice_func.txt" \
  DAFL_DFG_SCORE="$VULNFIX_HOME/vulnfix/data/zziplib/cve_2017_5976/sparrow-out/bug/slice_dfg.txt" \
