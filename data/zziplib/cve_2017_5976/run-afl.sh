...
TARGET_DIR="$VULNFIX_HOME/vulnfix/data/zziplib/cve_2017_5976"
...
for file in "$SEED_DIR"*; do
    ...
    file_list=("exploit" "seed9" "seed50" "seed31" "seed5" "seed44" "seed38" "seed46" "seed37" "seed40" "seed34" "seed22" "seed1" "seed12" "seed20" "seed11" "seed15" "seed2" "seed13")
    #file_list=("exploit" "seed46" "seed44" "seed33" "seed35" "seed28" "seed3" "seed30" "seed10" "seed17")
