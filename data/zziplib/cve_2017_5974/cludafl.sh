...
# python3 $VULNFIX_HOME/vulnfix/src/add_lv.py 221 repair-out/live_variables ./source/zzip/memdisk.c
...
pushd dafl_source
  DAFL_SELECTIVE_COV="$VULNFIX_HOME/vulnfix/data/zziplib/cve_2017_5974/sparrow-out/bug/slice_func.txt" \
  DAFL_DFG_SCORE="$VULNFIX_HOME/vulnfix/data/zziplib/cve_2017_5974/sparrow-out/bug/slice_dfg.txt" \
