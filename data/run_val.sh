...
# subjects=("libtiff/cve_2016_5321")
...
for subject in "${subjects[@]}"; do
  (
    ...
    for i in {12..12}; do
    (
      echo "Starting get_val.py $i for $subject"
      python3 get_val.py $subject $i
      echo "get_val.py $i for $subject has completed."
    )
    done
    ...
    pushd $subject
      ...
      (
        ...
        rsync -az aflrun_samples/out-$i/ runtime/afl-out/memory/
        ./rerun.sh
        mv runtime/pacfix.log aflrun_samples/pacfix-$i.log
